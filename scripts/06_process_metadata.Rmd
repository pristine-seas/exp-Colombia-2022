...
cabo_stations <- c("COL_birds_48","COL_birds_49", "COL_birds_50", "COL_birds_58", "COL_birds_59",
                   ...
                   "COL_uvs_03","COL_uvs_09", "COL_uvs_10", "COL_uvs_14", "COL_uvs_15", "COL_uvs_16",
...
utria_stations <- c("COL_birds_45", "COL_birds_46", "COL_birds_63", "COL_birds_64", "COL_birds_65", "COL_birds_66",
                    ...
                    "COL_uvs_06","COL_uvs_07", "COL_uvs_08", "COL_uvs_18", "COL_uvs_19", "COL_uvs_20",
...
meso_uwa_meta <- readxl::read_xlsx(file.path(ps_exp_path, 
                                   ...
                                   sheet = "Metadata") %>% 
  janitor::clean_names() %>% 
  dplyr::select(ps_station_id, analyzed_by = em_date, status, analyzed_on = em_date, analysis_comments)
...
exp_meta <- bind_rows(
  uvs_meta %>% 
    distinct(ps_station_id, ps_sample_id, method, date, location, sublocation, time,
             lat, lon, depth_m, 
             team_lead  = diver),
  tags_sets_meta %>% 
